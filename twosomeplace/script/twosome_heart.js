...
$(function () {
  let current = 0;
  $("ul.title_sub li").eq(0).addClass("on");
...
$(function () {
  function nextani() {
    $(".event1_banner").animate({ left: "-100%" }, 2500, function () {
  ...
  let inter = setInterval(nextani, 2500);
  $(".event1").hover(
    function () {
      clearInterval(inter);
    },
    function () {
      inter = setInterval(nextani, 2500);
    }
  );
  ...
  // event1
  // $(function () {
  //   $(".e_right").click(function (e) {
  //     $(".event1_banner li").eq(0).css({left: "0"}) .animate({ left: "-100%" });
  //     // console.log(i);
  //   });
